...
public:
	...
	virtual int SetAnnoMultiWindow(
		IN AnnoWindowMultiMonitor* annoWindows,
		IN int number) = 0;
	...
	virtual void SetAnnoSetting(
		IN const void* pData
	) = 0;

	virtual int SetQmlEngine(IN const void* qml_engine){return 0;}
};
